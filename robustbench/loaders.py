...
class CustomDatasetFolder(VisionDataset):
    ...
    def __getitem__(self, index):
        ...
        # print(sample.size,'sample_shape_before')
        sample_np = np.array(sample)
            
        mean_rgb = sample_np.mean(axis=(0, 1))  # [R_mean, G_mean, B_mean]
        # print(mean_rgb,'mean_rgb')
        # print(self.transform,'self.transform_before')
        ...
        sample_np = np.array(sample)
        mean_rgb = sample_np.mean(axis=(1,2))  # [R_mean, G_mean, B_mean]

        # print(mean_rgb,'mean_rgb_after')
